...
2026-05-17: Asked Gemini to locate the reason the add to cart funtion was not running correcly as the console log said it was ready. The problem occured when I was coding the past 2 days, and I was going into a rabbithole and was not able to make things work, then proceeded to try the "discard changes" in VSCode in conjunctioin with CTRL + Z, in order to go back to the previous commit that I knew for a fact would work. However it did not work as intedned, and I was lost in where I was in my earlier code. I rechecked my code, but didn't find the fault. Turns out I was havind some issues with the toTopBtn on the cart.js file, as it was causing a crash, which stopped the rest of the code to run, as it was casuing it to leak globally. By moving it inside the function, I was able to make the code run smoothly, and I can now add items to the cart, and it will show up on the other pages (stored locally).
